...
滑块小部件本身不保持任何状态State。相反，当滑块状态发生变化时，窗口小部件会调用**onChanged**回调。大多数使用滑块的小部件将侦听 **onChanged **回调并使用新值重建滑块以更新滑块的视觉外观。要知道值何时开始更改，或何时更改，请设置可选回调**onChangeStart**和/或**onChangeEnd**。
